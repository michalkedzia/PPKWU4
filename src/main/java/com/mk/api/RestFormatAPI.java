...
public class RestFormatAPI {
    ...
    public String responseAsText(@PathVariable("format") String format, @PathVariable("parameter") String parameter) {
        return restService.getStringInformation(parameter,format) + " " + "text";
    }
